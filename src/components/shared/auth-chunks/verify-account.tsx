...
import { sendOtpApi, verifyAccountApi } from "@/lib/api/auth-apis"
...
export function VerifyAccount({ setAuthSections }: Props) {
    ...
    >
      <FieldGroup>
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="text-sm">{t("didntReceiveCode")}</div>
          <button
            type="button"
