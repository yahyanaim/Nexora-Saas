...
import { SearchIcon, CheckIcon } from "@/components/ui/carbon/icons"
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        ...
        className={cn(
          "max-w-2xl overflow-hidden rounded-xl! p-0 shadow-2xl",
          className
        )}
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-8! rounded-lg! border-input/30 bg-input/30 shadow-none!">
        ...
        />
        <InputGroupAddon>
          <SearchIcon className="mx-2 size-4 shrink-0 opacity-50" />
        </InputGroupAddon>
      </InputGroup>
    </div>
  )
